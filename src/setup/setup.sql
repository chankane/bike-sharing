...
/* Insert data fron CSV */

\COPY station FROM 'data/station.csv' DELIMITERS ',' NULL '\N';
\COPY trip FROM 'data/trip.csv' DELIMITERS ',' NULL '\N';
\COPY weather FROM 'data/weather.csv' DELIMITERS ',' NULL '\N';
